<template>
  <div class="ebl-page-container">
    ...
    <div class="ebl-card-container">
      ...
      <div class="ebl-task-card-list ebl-task-card-list--5col">
...
const inProgressItems = ref([
  ...
  {
    title: 'Presentation',
    tooltip: '6 Approved  l  6 Rejected  l  6 Wait',
    value: 15,
    unit: 'Submit',
    color: 'blue',
    outlined: false,
...
// 최근 B/L 태스크 목록
const recentBlTasks = ref([
  {
    type: 'noti',
    title: 'User permissions have been updated.2',
  },
  ...dummyTasks,
  ...dummyTasks,
])
