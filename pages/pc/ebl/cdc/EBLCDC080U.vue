...
const pageInfo = ref({
  title: 'Archive',
  breadcrumbItems: [{ text: 'Menu' }, { text: 'Documents' }, { text: 'Archive' }],
})
...
const generateDummyData = () => {
  ...
  const blStatus = ['ISSUED', 'AMENDING', 'SWITCHING', 'DELIVERY', 'PENDING', 'VOIDED']
...
const resetFilters = () => {
  ...
  filters.dgType = 'ALL', // [추가] DG 필터 입력 상태 초기값
...
const openDetailDialog = (row) => {
  ...
  formData.lastUpdate = row.lastUpdate
