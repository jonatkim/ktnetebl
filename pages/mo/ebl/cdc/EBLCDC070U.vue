...
// ============================================
const goToDetail = () => {
  router.push('/mo/ebl/doc/EBLDOC150P_APPROVE')
}
...
const items = ref(
  Array.from({ length: 50 }, (_, index) => {
    ...
    return {
      ...
      badges: [
        { label: 'PENDING', color: 'amber', tooltip: 'Pending' },
        { label: 'TRANSFER', color: 'gray', tooltip: 'Transfer' },
      ],
      shipper: {
      ...
      requestText: REQUEST_TEXTS[index % REQUEST_TEXTS.length],
